...
type TestService = InstanceType<typeof import('D:/MyProject/2024/1/phecda/examples/server/src/server/test.service')['TestService']>
  ...
  const getKey: typeof import('phecda-server')['getKey']
  ...
  const getOwnStateVars: typeof import('phecda-server')['getOwnStateVars']
  ...
  const setStateVar: typeof import('phecda-server')['setStateVar']
