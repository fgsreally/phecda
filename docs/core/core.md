...
```ts
// 这个属性是含有数据的
declare function setMetaKey(proto: Phecda, key: PropertyKey): void
...
// 属性上注册状态
declare function setMeta(proto: Phecda, key: PropertyKey, state: Record<string, any>): void
// 获得类上所有含数据的属性（不包括父类）
...
// 获得类上注册的状态
declare function getMeta(target: any, key: PropertyKey): any
declare function getOwnMeta(target: any, key: PropertyKey): Record<string, any>
// 类上添加/获取属性
